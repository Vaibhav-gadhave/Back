...
echo Running command: Set-DNSClientServerAddress 'Ethernet' -ServerAddresses ('192.168.0.10','1.1.1.1')
powershell -Command "Set-DNSClientServerAddress 'Ethernet' -ServerAddresses ('192.168.0.10','1.1.1.1')"
